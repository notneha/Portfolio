...
export const experience = [
  {
    ...
    tech: ["Conversational AI", "GLiNER", "PII Redaction", "PaddleOCR", "OpenCV", "Agent Security"],
  },
  {
...
export const education = [
  ...
  {
    degree: "Intermediate",
    institution: "Govt. Degree Science & Commerce College, Malir Cantonment",
    duration: "2018 – 2020",
    detail: "Grade: 82.82%",
  },
] as const;
...
export const certifications = [
  ...
  {
    issuer: "Microsoft",
    items: ["Microsoft Azure for AI and Machine Learning"],
  },
  {
    issuer: "Meta",

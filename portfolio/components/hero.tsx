      ...
      <div className="section-shell relative z-10 grid items-center gap-12 py-16 lg:grid-cols-[1.15fr_0.85fr]">
        <div>
          ...
          <motion.div
            ...
            className="mt-4 flex h-9 items-center font-mono text-lg text-accent sm:text-xl"
          >
            <span>{typed}</span>
        ...
        >
          ...
          <div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-[2rem] glass">
            ...
            <span
              className="absolute h-2.5 w-2.5 rounded-full bg-accent shadow-[0_0_12px_2px_rgba(94,234,212,0.6)]"
              style={{ top: "12%", left: "18%" }}
              aria-hidden="true"
            />
            <span
              className="absolute h-2 w-2 rounded-full bg-secondary shadow-[0_0_10px_2px_rgba(139,124,246,0.55)]"
